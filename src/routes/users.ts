...
import { addAddress, changeUserRole, deleteAddress, getAgentBranch, getRepBranches, getUserById, listAddress, listAgents, listReps, listUsers, updateUser } from "../controllers/users";
...
userRoutes.get('/rep-branch/:userId', [authMiddleware], errorHandler(getRepBranches))
